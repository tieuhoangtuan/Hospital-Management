...
public class accountGUI extends JFrame {
	...
	String producerList[] = {"", "Admin", "Bác sĩ", "Nhân viên" };
	...
	public accountGUI() {
		...
		btnRemove.setBackground(new Color(255, 250, 205));
		btnRemove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				do_btnRemove_actionPerformed(e);
			}
		});
		btnRemove.setBounds(136, 391, 85, 42);
		...
		btnEdit.setBounds(250, 391, 85, 42);
		panel_1.add(btnEdit);

		JButton btnAdd = new JButton("Thêm");
		btnAdd.setBackground(new Color(255, 250, 205));
